...
// Belt-and-braces: explicitly unset any external-service credentials so a
// developer's local .env (or stray CI env) can't make tests call the live
// Mailboxlayer / Supabase / Cloudinary APIs.
for (const k of [
  'MAILBOXLAYER_KEY',
